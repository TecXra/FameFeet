    ...
    <div class="card ">
      ...
      <div class="card-body">
        <div class="table-responsive">
            ...
            <tbody>
               {{-- {{ $blockUsers }} --}}
                ...
                <td>
                  ...
                  <td>
                    {{$blockUser->date_of_birth}}
                  </td>

                    @if ($blockUser->user_type == 1)
                      <td>Celebrity</td>
                      @elseif ($blockUser->user_type == 2)
                      <td>Fan</td>
                      @elseif ($blockUser->user_type == 9)
                      <td>Admin</td>
                    @endif

                    <td style="text-align: center">
                        <a href="{{ route('celebrity.unblock.user',$blockUser->id) }}"
          ...
          {{ $blockUsers->links('pagination::bootstrap-4') }}
        </div>
      </div>
    </div>
  </div>
