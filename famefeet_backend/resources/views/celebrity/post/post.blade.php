        ...
        <div class="table-responsive">
          <table class="table tablesorter ">
            ...
            <tbody>
                ...
                @if ($post->content_type == config('famefeet.content_type.images'))
                    <td>Images</td>
                @elseif ($post->content_type == config('famefeet.content_type.videos'))
                    <td>Videos</td>
                @endif
                <td>{{date("F j, Y, g:i a", strtotime($post->created_at))}}</td>
                <td>
                    <a href="{{ route('celebrity.post.edit',$post->id) }}"
                    ...
                    <a href="{{ route('celebrity.post.show',$post->id) }}"
