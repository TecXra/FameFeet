...
class OrderCancelAdminNotification extends Notification
{
    use Queueable;
    public $admin;
    public $celeb;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->line($celeb[0].' had their order cancelled due to not uploading the tracking ID.')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => " Order cancelled due to non activity on order.",
