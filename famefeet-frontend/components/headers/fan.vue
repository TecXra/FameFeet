<template>
  <b-navbar toggleable="lg" class="ff-Navbar-Mian py-0">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav>
        <b-nav-item
          :class="{ active: isLinkActive('/fan/celebrities') }"
          class="navbar-Mian-Item px-1 text-uppercase"
          @click="goToDashboard('/fan/feeds')"
          v-if="loggedIn"
        >
          My Dashboard
        </b-nav-item>
      ...
      <b-navbar-nav class="ml-auto" v-if="loggedIn">
        ...
        <div class="d-flex ml-2 ml-lg-0">
          <b-nav-item class="mr-3 mr-lg-0" v-if="msgCounter > 0">
            <div class="" @click="goToPage('/fan/messages')">
              <b-avatar
                badge-offset="-0.2em"
          ...
          <b-nav-item class="mr-3 mr-lg-0" v-if="notifications > 0">
            <div class="" @click="goToPage('/fan/notifications')">
              <b-avatar
                badge-offset="-0.2em"
          ...
          <b-nav-item class="" v-show="totalQty() > 0">
        ...
        <b-nav-item-dropdown right no-caret class="d-none d-lg-block">
          <template #button-content>
            <b-avatar class="my-0 py-0 navbar-dropdown-avatar" :src="user.avatarURL"></b-avatar>
          </template>
          <b-dropdown-item @click="goToPage('/fan/settings/profile')"
...
export default {
 ...
 async mounted() {
  ...
  methods: {
    ...
    acceptOffer() {
      this.echo.channel(`accept-offer.${this.$auth.user.id}`).listen(
        ".AcceptOffer",
        (e) => {
          // this.notifications.push(e);
          this.notifications++;
